...
> ```
>
> Install the heavier notebook and visualization stack too:
> ```bash
> INSTALL_LABS=1 curl -fsSL https://raw.githubusercontent.com/jasperan/data-in-ai-revolution/main/install.sh | bash
> ```
>
> Or install manually:
> ```bash
...
![AI Data Lab overview](./img/tui-overview.svg)
...
![AI Data Lab environment doctor](./img/tui-doctor.svg)

### Slides

Open the HTML deck here: [frontend-slides/tui-tour.html](./frontend-slides/tui-tour.html)
...
https://github.com/user-attachments/assets/6b2f650f-cd21-4306-b060-b2d8cef5f283
...
https://github.com/user-attachments/assets/4bc0a81e-f871-4bdf-b895-b221d5e696ea
...
https://github.com/user-attachments/assets/260c4963-e405-4d29-886f-2e1f0aaa3d6e
